        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="text-center mb-16 max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
              ...
              <br /><span className="text-blue-600">Fontaneros en Vigo</span>
            </h2>
            <p className="text-lg text-gray-600">
              Completa el formulario y te llamaremos inmediatamente para resolver tu problema
            </p>
          </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 h-full">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-800 mb-1">Respuesta inmediata</h4>
                      <p className="text-gray-600">Atendemos emergencias las 24 horas con un tiempo medio de respuesta de 45 minutos en Vigo.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Todos nuestros trabajos incluyen 2 años de garantía por escrito. Tu satisfacción está asegurada.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Presupuesto sin compromiso y sin sorpresas. Le mostramos el precio antes de comenzar.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Fontaneros profesionales con más de 10 años de experiencia y certificación en instalaciones de gas.</p>
                    </div>
                  </div>
                </div>

                <div className="mt-10 pt-6 border-t border-gray-200">
                  <h4 className="font-bold text-gray-800 mb-3">Zonas de actuación:</h4>
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                {this.state.isSubmitted ? (
                  <div className="p-10 text-center">
                    ...
                    <p className="text-gray-600 mb-6">Nos pondremos en Contact contigo en menos de 10 minutos.</p>
                    <button
                  ...
                  <form onSubmit={this.handleSubmit} className="p-6 sm:p-10">
                    ...
                    <div className="mt-4 text-center text-gray-500 text-sm">
                      <p>Responderemos en menos de 10 minutos</p>
                    </div>
                  </form>
                )}
              </div>
          ...
          <div className="mt-12 text-center">
            <div className="inline-flex flex-col sm:flex-row items-center justify-center bg-white rounded-full shadow-lg overflow-hidden border border-gray-200">
              <a 
                href="tel:+34612345678" 
                className="flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-8 transition-colors"
              >
                <FaPhone className="mr-3" />
                <span>Llamar ahora: 612 345 678</span>
              </a>
              <a 
                href="mailto:info@fontanerosvigo.com" 
                className="flex items-center justify-center text-gray-700 font-medium py-4 px-8 hover:bg-gray-50 transition-colors"
              >
                <svg className="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                  <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                </svg>
                <span>info@fontanerosvigo.com</span>
              </a>
            </div>
          </div>
        </div>
